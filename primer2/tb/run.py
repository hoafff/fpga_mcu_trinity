...
def main()->int:
    ...
    tops=['tb_ascon_aead128_decrypt','tb_uart_rx_byte','tb_uart_frame_receiver','tb_spi_packet_endpoint','tb_primer2_command_core','tb_bad_tag_threshold','tb_primer2_top']
    failures=[]
